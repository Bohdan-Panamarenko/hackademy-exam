...
func AddTask(rw http.ResponseWriter, r *http.Request, u *UserToDoStorage) {
...
type UpdateTaskParams struct {
	...
	UpdateIsOpen      bool `json:"update_is_open"`
...
func (t *Task) update(params UpdateTaskParams) {
	...
	if params.UpdateIsOpen {
		t.open = params.IsOpen
	}
}

func UpdateTask(rw http.ResponseWriter, r *http.Request, u *UserToDoStorage) {
...
func DeleteTask(rw http.ResponseWriter, r *http.Request, u *UserToDoStorage) {
	vars := mux.Vars(r)
...
func GetTasks(rw http.ResponseWriter, r *http.Request, u *UserToDoStorage) {
	vars := mux.Vars(r)
	...
	for _, key := range keys {
		...
		object["open"] = fmt.Sprint(task.open)
		object["data"] = fmt.Sprint(task.date)
